    ...
    <main class="main-content">
      ...
      <div class="dashboard-cards">
        ...
        <div class="card stat-card">
          ...
          <a href="careers.php"><?php echo $rec_count > 0 ? 'View recommendations →' : 'Get recommendations →'; ?></a>
        </div>
      </div>
      ...
      <div class="card growth-card">
        ...
        <ul class="growth-list">
          ...
          <li>
            ...
            <a href="careers.php">Browse careers</a></span>
          </li>
          <li>
            ...
            <a href="careers.php">Choose a career</a></span>
          </li>
          <li>
